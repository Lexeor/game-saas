    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-4">
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="rounded-2xl bg-surface p-8 shadow-[0_24px_64px_rgba(0,0,0,0.5)]">
          <h1 className="space-grotesk mb-1 text-xl font-bold text-foreground">Create account</h1>
          <p className="mb-6 text-sm text-foreground/40">Your server will be ready in under 60 seconds</p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-medium text-foreground/50">Confirm password</label>
              <input
                type="password"
                autoComplete="new-password"
                placeholder="••••••••"
